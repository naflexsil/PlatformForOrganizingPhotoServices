...
const SoulSection = ({ onOpenAuthModal }) => {
  const benefits = [
    ...
    "Система рекомендаций помогает пользователям находить фотографов, стиль которых соответствует их запросу",
    "Настраивайте стоимость услуг, скидки и условия съемок в одном месте и управляйте заказами без лишних сервисов",
  ];
